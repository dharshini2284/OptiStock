...
public class PurchasePage extends javax.swing.JPanel {
    ...
    public PurchasePage(Dashboard dashboard) {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(Color.WHITE),"Enter Customer Details", javax.swing.border.TitledBorder.LEFT,javax.swing.border.TitledBorder.TOP, 
                            new java.awt.Font("Arial", java.awt.Font.BOLD, 14), new Color(57, 255, 20) ));


        jLabel3.setText("Product Code:");
        jLabel3.setForeground(new Color(57, 255, 20));

        jLabel4.setText("Product Name:");
        jLabel4.setForeground(new Color(57, 255, 20));

        jLabel6.setText("Quantity:");
        jLabel6.setForeground(new Color(57, 255, 20));

        jLabel7.setText("Cost Price:");
        jLabel7.setForeground(new Color(57, 255, 20));

        jLabel8.setText("Selling Price:");
        jLabel8.setForeground(new Color(57, 255, 20));
        ...
        purchaseButton.setForeground(new Color(57, 255, 20));
        ...
        purchaseTable.setBackground(new Color(57, 255, 20));
