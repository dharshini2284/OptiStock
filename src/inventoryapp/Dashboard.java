...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        prodButton.setBackground(Color.BLACK);
        prodButton.setForeground(new Color(57, 255, 20));
        ...
        stockButton.setForeground(new Color(57, 255, 20));
        ...
        custButton.setForeground(new Color(57, 255, 20));
